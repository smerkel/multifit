...
label = WIDGET_LABEL(base2, VALUE='Detec. offset', /ALIGN_LEFT, xsize=150)
...
base2 = WIDGET_BASE(base, /row)
label = WIDGET_LABEL(base2, VALUE='Inner radius', /ALIGN_LEFT, xsize=150)
innerRadiusText = WIDGET_TEXT(base2, VALUE='400', XSIZE=10, /EDITABLE)
label = WIDGET_LABEL(base2, VALUE='Outer radius', /ALIGN_LEFT, xsize=150)
